package com.freedom.wecore.widget.refresh.internal;
...
public abstract class InternalAbstract extends RelativeLayout implements RefreshInternal {
    ...
    public SpinnerStyle getSpinnerStyle() {
        ...
        if (mWrapperView != null) {
            ...
            if (params instanceof WeRefreshLayout.LayoutParams) {
                mSpinnerStyle = ((WeRefreshLayout.LayoutParams) params).spinnerStyle;
                if (mSpinnerStyle != null) {
                    return mSpinnerStyle;
                }
            }
    ...
    public void onInitialized(@NonNull RefreshKernel kernel, int height, int maxDragHeight) {
        if (mWrapperView instanceof RefreshInternal) {
            ...
            ViewGroup.LayoutParams params = mWrapperView.getLayoutParams();
            if (params instanceof WeRefreshLayout.LayoutParams) {
                kernel.requestDrawBackgroundFor(this, ((WeRefreshLayout.LayoutParams) params).backgroundColor);
            }
        }
    }
