...
import com.freedom.wecore.widget.refresh.api.DefaultRefreshFooterCreator;
import com.freedom.wecore.widget.refresh.api.DefaultRefreshHeaderCreator;
import com.freedom.wecore.widget.refresh.api.RefreshContent;
import com.freedom.wecore.widget.refresh.api.RefreshFooter;
import com.freedom.wecore.widget.refresh.api.RefreshHeader;
import com.freedom.wecore.widget.refresh.api.RefreshInternal;
import com.freedom.wecore.widget.refresh.api.RefreshKernel;
import com.freedom.wecore.widget.refresh.api.RefreshLayout;
import com.freedom.wecore.widget.refresh.api.ScrollBoundaryDecider;
import com.freedom.wecore.widget.refresh.constant.DimensionStatus;
...
import com.freedom.wecore.widget.refresh.footer.BallPulseFooter;
import com.freedom.wecore.widget.refresh.header.BezierRadarHeader;
import com.freedom.wecore.widget.refresh.impl.RefreshContentWrapper;
import com.freedom.wecore.widget.refresh.impl.RefreshFooterWrapper;
import com.freedom.wecore.widget.refresh.impl.RefreshHeaderWrapper;
import com.freedom.wecore.widget.refresh.listener.OnLoadMoreListener;
import com.freedom.wecore.widget.refresh.listener.OnMultiPurposeListener;
...
import com.freedom.wecore.widget.refresh.listener.OnStateChangedListener;
import com.freedom.wecore.widget.refresh.util.DelayedRunnable;
import com.freedom.wecore.widget.refresh.util.DensityUtil;
import com.freedom.wecore.widget.refresh.util.ScrollBoundaryUtil;
import com.freedom.wecore.widget.refresh.util.ViscousFluidInterpolator;
...
import static com.freedom.wecore.widget.refresh.util.DensityUtil.dp2px;
import static com.freedom.wecore.widget.refresh.util.SmartUtil.fling;
import static com.freedom.wecore.widget.refresh.util.SmartUtil.getColor;
import static com.freedom.wecore.widget.refresh.util.SmartUtil.isScrollableView;
...
public class WeRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
...
//    protected int mFooterExtendHeight;  //扩展高度
    ...
    public WeRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.WeRefreshLayout);

        setNestedScrollingEnabled(ta.getBoolean(R.styleable.WeRefreshLayout_srlEnableNestedScrolling, false));
        mDragRate = ta.getFloat(R.styleable.WeRefreshLayout_srlDragRate, mDragRate);
        mHeaderMaxDragRate = ta.getFloat(R.styleable.WeRefreshLayout_srlHeaderMaxDragRate, mHeaderMaxDragRate);
        mFooterMaxDragRate = ta.getFloat(R.styleable.WeRefreshLayout_srlFooterMaxDragRate, mFooterMaxDragRate);
        mHeaderTriggerRate = ta.getFloat(R.styleable.WeRefreshLayout_srlHeaderTriggerRate, mHeaderTriggerRate);
        mFooterTriggerRate = ta.getFloat(R.styleable.WeRefreshLayout_srlFooterTriggerRate, mFooterTriggerRate);
        mEnableRefresh = ta.getBoolean(R.styleable.WeRefreshLayout_srlEnableRefresh, mEnableRefresh);
        mReboundDuration = ta.getInt(R.styleable.WeRefreshLayout_srlReboundDuration, mReboundDuration);
        mEnableLoadMore = ta.getBoolean(R.styleable.WeRefreshLayout_srlEnableLoadMore, mEnableLoadMore);
        mHeaderHeight = ta.getDimensionPixelOffset(R.styleable.WeRefreshLayout_srlHeaderHeight, density.dip2px(100));
        mFooterHeight = ta.getDimensionPixelOffset(R.styleable.WeRefreshLayout_srlFooterHeight, density.dip2px(60));
        mHeaderInsetStart = ta.getDimensionPixelOffset(R.styleable.WeRefreshLayout_srlHeaderInsetStart, 0);
        mFooterInsetStart = ta.getDimensionPixelOffset(R.styleable.WeRefreshLayout_srlFooterInsetStart, 0);
        mDisableContentWhenRefresh = ta.getBoolean(R.styleable.WeRefreshLayout_srlDisableContentWhenRefresh, mDisableContentWhenRefresh);
        mDisableContentWhenLoading = ta.getBoolean(R.styleable.WeRefreshLayout_srlDisableContentWhenLoading, mDisableContentWhenLoading);
        mEnableHeaderTranslationContent = ta.getBoolean(R.styleable.WeRefreshLayout_srlEnableHeaderTranslationContent, mEnableHeaderTranslationContent);
        mEnableFooterTranslationContent = ta.getBoolean(R.styleable.WeRefreshLayout_srlEnableFooterTranslationContent, mEnableFooterTranslationContent);
        mEnablePreviewInEditMode = ta.getBoolean(R.styleable.WeRefreshLayout_srlEnablePreviewInEditMode, mEnablePreviewInEditMode);
        mEnableAutoLoadMore = ta.getBoolean(R.styleable.WeRefreshLayout_srlEnableAutoLoadMore, mEnableAutoLoadMore);
        mEnableOverScrollBounce = ta.getBoolean(R.styleable.WeRefreshLayout_srlEnableOverScrollBounce, mEnableOverScrollBounce);
        mEnablePureScrollMode = ta.getBoolean(R.styleable.WeRefreshLayout_srlEnablePureScrollMode, mEnablePureScrollMode);
        mEnableScrollContentWhenLoaded = ta.getBoolean(R.styleable.WeRefreshLayout_srlEnableScrollContentWhenLoaded, mEnableScrollContentWhenLoaded);
        mEnableScrollContentWhenRefreshed = ta.getBoolean(R.styleable.WeRefreshLayout_srlEnableScrollContentWhenRefreshed, mEnableScrollContentWhenRefreshed);
        mEnableLoadMoreWhenContentNotFull = ta.getBoolean(R.styleable.WeRefreshLayout_srlEnableLoadMoreWhenContentNotFull, mEnableLoadMoreWhenContentNotFull);
        mEnableFooterFollowWhenLoadFinished = ta.getBoolean(R.styleable.WeRefreshLayout_srlEnableFooterFollowWhenLoadFinished, mEnableFooterFollowWhenLoadFinished);
        mEnableClipHeaderWhenFixedBehind = ta.getBoolean(R.styleable.WeRefreshLayout_srlEnableClipHeaderWhenFixedBehind, mEnableClipHeaderWhenFixedBehind);
        mEnableClipFooterWhenFixedBehind = ta.getBoolean(R.styleable.WeRefreshLayout_srlEnableClipFooterWhenFixedBehind, mEnableClipFooterWhenFixedBehind);
        mEnableOverScrollDrag = ta.getBoolean(R.styleable.WeRefreshLayout_srlEnableOverScrollDrag, mEnableOverScrollDrag);
        mFixedHeaderViewId = ta.getResourceId(R.styleable.WeRefreshLayout_srlFixedHeaderViewId, View.NO_ID);
        mFixedFooterViewId = ta.getResourceId(R.styleable.WeRefreshLayout_srlFixedFooterViewId, View.NO_ID);
        mHeaderTranslationViewId = ta.getResourceId(R.styleable.WeRefreshLayout_srlHeaderTranslationViewId, View.NO_ID);
        mFooterTranslationViewId = ta.getResourceId(R.styleable.WeRefreshLayout_srlFooterTranslationViewId, View.NO_ID);

        if (mEnablePureScrollMode && !ta.hasValue(R.styleable.WeRefreshLayout_srlEnableOverScrollDrag)) {
            mEnableOverScrollDrag = true;
        }

        mManualLoadMore = ta.hasValue(R.styleable.WeRefreshLayout_srlEnableLoadMore);
        mManualNestedScrolling = ta.hasValue(R.styleable.WeRefreshLayout_srlEnableNestedScrolling);
        mManualHeaderTranslationContent = ta.hasValue(R.styleable.WeRefreshLayout_srlEnableHeaderTranslationContent);
        mHeaderHeightStatus = ta.hasValue(R.styleable.WeRefreshLayout_srlHeaderHeight) ? DimensionStatus.XmlLayoutUnNotify : mHeaderHeightStatus;
        mFooterHeightStatus = ta.hasValue(R.styleable.WeRefreshLayout_srlFooterHeight) ? DimensionStatus.XmlLayoutUnNotify : mFooterHeightStatus;
...
//        mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
        ...
        int accentColor = ta.getColor(R.styleable.WeRefreshLayout_srlAccentColor, 0);
        int primaryColor = ta.getColor(R.styleable.WeRefreshLayout_srlPrimaryColor, 0);
        if (primaryColor != 0) {
            if (accentColor != 0) {
        ...
        if (!thisView.isInEditMode()) {
            ...
            if (!mManualNestedScrolling && !isNestedScrollingEnabled()) {
                post(new Runnable() {
                    @Override
                    public void run() {
                        final View thisView = WeRefreshLayout.this;
                        for (ViewParent parent = thisView.getParent() ; parent != null ; ) {
                            if (parent instanceof NestedScrollingParent) {
                                View target = WeRefreshLayout.this;
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshListener != null) {
                    mRefreshListener.onRefresh(WeRefreshLayout.this);
                } else if (mOnMultiPurposeListener == null) {
                    finishRefresh(3000);
                }
                if (mRefreshHeader != null) {
                    mRefreshHeader.onStartAnimator(WeRefreshLayout.this, mHeaderHeight,  (int) (mHeaderMaxDragRate * mHeaderHeight));
                }
                if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    mOnMultiPurposeListener.onRefresh(WeRefreshLayout.this);
...
//            reboundAnimator.setDuration(20000);
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.WeRefreshLayout_Layout);
            backgroundColor = ta.getColor(R.styleable.WeRefreshLayout_Layout_layout_srlBackgroundColor, backgroundColor);
            if (ta.hasValue(R.styleable.WeRefreshLayout_Layout_layout_srlSpinnerStyle)) {
                spinnerStyle = SpinnerStyle.values()[ta.getInt(R.styleable.WeRefreshLayout_Layout_layout_srlSpinnerStyle, SpinnerStyle.Translate.ordinal())];
            }
            ta.recycle();
        }
...
//    }
    ...
    @Override
    public WeRefreshLayout setFooterHeight(float heightDp) {
...
//    @Override
//    public WeRefreshLayout setFooterHeightPx(int heightPx) {
//        if (mFooterHeightStatus.canReplaceWith(DimensionStatus.CodeExact)) {
...
//    }
    ...
    @Override
    public WeRefreshLayout setHeaderHeight(float heightDp) {
...
//    @Override
//    public WeRefreshLayout setHeaderHeightPx(int heightPx) {
//        if (mHeaderHeightStatus.canReplaceWith(DimensionStatus.CodeExact)) {
...
//    }
    ...
    @Override
    public WeRefreshLayout setHeaderInsetStart(float insetDp) {
...
//    @Override
//    public WeRefreshLayout setHeaderInsetStartPx(int insetPx) {
//        mHeaderInsetStart = insetPx;
//        return this;
//    }

    @Override
    public WeRefreshLayout setFooterInsetStart(float insetDp) {
...
//    @Override
//    public WeRefreshLayout setFooterInsetStartPx(int insetPx) {
...
//    }
     ...
     */
    @Override
    public WeRefreshLayout setDragRate(float rate) {
        this.mDragRate = rate;
        return this;
    }
     ...
     */
    @Override
    public WeRefreshLayout setHeaderMaxDragRate(float rate) {
...
//        this.mHeaderExtendHeight = (int) Math.max((mHeaderHeight * (mHeaderMaxDragRate - 1)), 0);
     ...
     * @return WeRefreshLayout
     */
    @Override
    public WeRefreshLayout setFooterMaxDragRate(float rate) {
...
//        this.mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
     ...
     */
    @Override
    public WeRefreshLayout setHeaderTriggerRate(float rate) {
     ...
     */
    @Override
    public WeRefreshLayout setFooterTriggerRate(float rate) {
     ...
     */
    @Override
    public WeRefreshLayout setReboundInterpolator(@NonNull Interpolator interpolator) {
     ...
     */
    @Override
    public WeRefreshLayout setReboundDuration(int duration) {
     ...
     */
    @Override
    public WeRefreshLayout setEnableLoadMore(boolean enabled) {
     ...
     */
    @Override
    public WeRefreshLayout setEnableRefresh(boolean enabled) {
     ...
     */
    @Override
    public WeRefreshLayout setEnableHeaderTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public WeRefreshLayout setEnableFooterTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public WeRefreshLayout setEnableAutoLoadMore(boolean enabled) {
     ...
     */
    @Override
    public WeRefreshLayout setEnableOverScrollBounce(boolean enabled) {
     ...
     */
    @Override
    public WeRefreshLayout setEnablePureScrollMode(boolean enabled) {
     ...
     */
    @Override
    public WeRefreshLayout setEnableScrollContentWhenLoaded(boolean enabled) {
     ...
     */
    @Override
    public WeRefreshLayout setEnableScrollContentWhenRefreshed(boolean enabled) {
     ...
     */
    @Override
    public WeRefreshLayout setEnableLoadMoreWhenContentNotFull(boolean enabled) {
     ...
     */
    @Override
    public WeRefreshLayout setEnableOverScrollDrag(boolean enabled) {
     ...
     */
    @Override
    public WeRefreshLayout setEnableFooterFollowWhenLoadFinished(boolean enabled) {
     ...
     */
    @Override
    public WeRefreshLayout setEnableClipHeaderWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public WeRefreshLayout setEnableClipFooterWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public WeRefreshLayout setDisableContentWhenRefresh(boolean disable) {
     ...
     */
    @Override
    public WeRefreshLayout setDisableContentWhenLoading(boolean disable) {
     ...
     */
    @Override
    public WeRefreshLayout setRefreshHeader(@NonNull RefreshHeader header) {
     ...
     */
    @Override
    public WeRefreshLayout setRefreshHeader(@NonNull RefreshHeader header, int width, int height) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public WeRefreshLayout setRefreshFooter(@NonNull RefreshFooter footer) {
     ...
     */
    @Override
    public WeRefreshLayout setRefreshFooter(@NonNull RefreshFooter footer, int width, int height) {
        if (mRefreshFooter != null) {
     ...
     */
    @Override
    public WeRefreshLayout getLayout() {
        return this;
    }
     ...
     */
    @Override
    public WeRefreshLayout setOnRefreshListener(OnRefreshListener listener) {
     ...
     */
    @Override
    public WeRefreshLayout setOnLoadMoreListener(OnLoadMoreListener listener) {
     ...
     */
    @Override
    public WeRefreshLayout setOnRefreshLoadMoreListener(OnRefreshLoadMoreListener listener) {
        this.mRefreshListener = listener;
        this.mLoadMoreListener = listener;
        this.mEnableLoadMore = mEnableLoadMore || (!mManualLoadMore && listener != null);
        return this;
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.freedom.wecore.widget.refresh.listener.SimpleMultiPurposeListener}
     * @return WeRefreshLayout
     */
    @Override
    public WeRefreshLayout setOnMultiPurposeListener(OnMultiPurposeListener listener) {
     ...
     */
    @Override
    public WeRefreshLayout setPrimaryColors(@ColorInt int... primaryColors) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public WeRefreshLayout setPrimaryColorsId(@ColorRes int... primaryColorId) {
        final View thisView = this;
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link com.freedom.wecore.widget.refresh.impl.ScrollBoundaryDeciderAdapter}
     * @return WeRefreshLayout
     */
    @Override
    public WeRefreshLayout setScrollBoundaryDecider(ScrollBoundaryDecider boundary) {
     ...
     */
    @Override
    public WeRefreshLayout setNoMoreData(boolean noMoreData) {
     ...
     */
    @Override
    public WeRefreshLayout finishRefresh() {
     ...
     */
    @Override
    public WeRefreshLayout finishLoadMore() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public WeRefreshLayout finishRefresh(int delayed) {
     ...
     */
    @Override
    public WeRefreshLayout finishRefresh(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public WeRefreshLayout finishRefresh(int delayed, final boolean success) {
        postDelayed(new Runnable() {
            ...
            public void run() {
                if (mState == RefreshState.Refreshing && mRefreshHeader != null && mRefreshContent != null) {
                    ...
                    int startDelay = mRefreshHeader.onFinish(WeRefreshLayout.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            WeRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + mSpinner - mTouchSlop*2, 0));
                            WeRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + mSpinner, 0));
     ...
     */
    @Override
    public WeRefreshLayout finishLoadMore(int delayed) {
     ...
     */
    @Override
    public WeRefreshLayout finishLoadMore(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public WeRefreshLayout finishLoadMore(int delayed, final boolean success, final boolean noMoreData) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Loading && mRefreshFooter != null && mRefreshContent != null) {
                    notifyStateChanged(RefreshState.LoadFinish);
                    final int startDelay = mRefreshFooter.onFinish(WeRefreshLayout.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshFooter instanceof RefreshFooter) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            WeRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + offset + mTouchSlop * 2, 0));
                            WeRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + offset, 0));
                            if (mNestedInProgress) {
                                mTotalUnconsumed = 0;
                            }
...
//                            mTotalUnconsumed = 0;
//                            final long time = System.currentTimeMillis();
//                            WeRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_CANCEL, mLastTouchX, mTouchY + offset, 0));
                        }
                        //准备：偏移并结束状态
                        postDelayed(new Runnable() {
                            @Override
     ...
     */
    @Override
    public WeRefreshLayout finishLoadMoreWithNoMoreData() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
...
//    @Override
//    @Deprecated
//    public WeRefreshLayout resetNoMoreData() {
...
//    }
    ...
    public class RefreshKernelImpl implements RefreshKernel {
        ...
        public ValueAnimator animSpinner(int endSpinner) {
            return WeRefreshLayout.this.animSpinner(endSpinner, 0, mReboundInterpolator, mReboundDuration);
        }
